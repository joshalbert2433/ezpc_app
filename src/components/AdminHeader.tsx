...
export default function AdminHeader() {
  ...
  return (
    <header className="h-20 border-b border-[var(--card-border)] bg-[var(--background)]/50 backdrop-blur-md px-8 flex items-center justify-between sticky top-0 z-40 transition-colors duration-300">
      <div className="flex items-center gap-6">
        <button className="lg:hidden text-[var(--muted)]">
          <Menu size={24} />
        </button>
        <div className="flex items-center gap-3 bg-[var(--input)] border border-[var(--card-border)] px-4 py-2 rounded-xl w-64 md:w-96 group focus-within:border-[var(--primary)] transition-all">
      ...
      <div className="flex items-center gap-6">
        <button className="relative p-2 text-[var(--muted)] hover:text-[var(--primary)] bg-[var(--input)]/50 rounded-lg border border-[var(--card-border)] hover:border-[var(--primary)]/30 transition-all group">
          <Bell size={20} />
