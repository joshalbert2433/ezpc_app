      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-6 text-[var(--muted)]">
          ...
          <Link href="/wishlist" onClick={(e) => handleAuthRequired(e, '/wishlist')} className="relative group">
            ...
            {wishlist.length > 0 && (
              <span className="absolute -top-2 -right-2 bg-[var(--foreground)] text-[var(--background)] text-[10px] font-black px-1.5 rounded-full border border-(--card-border) shadow-lg animate-in fade-in zoom-in duration-300">
                {wishlist.length}
              </span>
            )}
          </Link>
          ...
          <Link href="/cart" onClick={(e) => handleAuthRequired(e, '/cart')} className="relative cursor-pointer group">
            ...
            {cart.length > 0 && (
              <span className="absolute -top-2 -right-2 bg-[var(--primary)] text-white dark:text-black text-[10px] font-black px-1.5 rounded-full border border-(--card-border) shadow-lg animate-in fade-in zoom-in duration-300">
