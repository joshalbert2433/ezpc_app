  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto px-6 py-20 text-center flex flex-col items-center justify-center space-y-4">
        ...
        <p className="animate-pulse text-[var(--muted)] font-black uppercase tracking-widest text-xs">Syncing saved products...</p>
      </div>
    );
  }
    ...
    <main className="max-w-7xl mx-auto px-6 py-12 transition-colors duration-300">
      <div className="flex items-center justify-between mb-12">
        <div>
          ...
          <p className="text-[var(--muted)] mt-2">Saved products for your future dream build</p>
        </div>
